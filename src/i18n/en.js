...
export default {
  ...
  guideFeatures: [
    ...
    { icon: '🍽️', title: 'Three meal modes', desc: 'Eating out, staying in, or eating on your own: everyone picks, only "eating out" joins the search. The whole table can see who\'s staying and who\'s going out.' },
    { icon: '⚠️', title: 'Allergies visible to the organizer', desc: 'Every declared allergy shows up in the waiting room, so the organizer can mention it to the restaurant when booking or arriving.' },
  ...
  guideLimits: [
    ...
    },
    {
      ...
      mitigation: 'If the quota is exceeded or the service is unavailable, the app automatically falls back to its standard selection (cuisine + mode), with no visible error but without that finer filtering that day.',
    },
    {
      severity: '🟢',
    ...
    },
    {
      ...
      desc: 'The screen updates itself automatically, but via periodic polling, with no notification if the app is closed.',
    },
  ],
  guideFaqTitle: 'FAQ',
  guideFaq: [
  ...
  feedbackVoteHint: '👍 Tap the thumb to vote for your favorites',
  feedbackEmpty: 'No feedback yet, be the first!',
  feedbackStatusIdea: '🆕 New',
